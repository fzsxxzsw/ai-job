...
const CLEAR_NON_TECHNICAL_TITLE = /(?:主播|直播带货|美妆|调解|催收|销售|客服|招聘|人事|行政|文员|商务拓展|商务推广|商务bd|渠道拓展|课程顾问|实施顾问|技术支持|售前|售后|客户成功|培训师|电话邀约|市场开发|业务开发|客户开发|产品经理|(?:产品|内容|用户|直播|新媒体)运营|运营(?:经理|主管|专员|总监|助理|实习|策划|岗)|数据标注|模型训练|短视频(?:剪辑|制作|拍摄|运营|编导|策划|创作|(?:ai|aigc)工程师)|视频(?:制作|剪辑)|剪辑|编导|导演|摄像师|摄影师|影视后期|后期制作|特效制作|内容创作|视觉设计师|平面设计师)/i
