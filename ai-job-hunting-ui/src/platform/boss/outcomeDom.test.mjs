...
const {captureCurrentOutcomePanel}=module.exports
function fixture({job='JobA',conversation='BossA:SecA',peer='81',panelSource=null}={}) {
 const selected={uid:'81',encryptBossId:'BossA',securityId:'SecA',encryptJobId:'JobA'}
 const raw={mid:'90071992547409933',from:{uid:peer},to:{uid:'40'},body:{text:'暂不合适'},encryptJobId:job,conversationKey:conversation}
 ...
 return {root,raw,panel,selection}
}
